...
void Windmill(){
    ...
    ///Windmill_Rotary_BladesMoving_Sun_Model
    glColor3f(0.11, 0.23, 0.36);
    glPushMatrix();
...
{
    printf("\n\n///-------Team: Black Ants---------///\n");
    printf("///-- Tamim Rahman Riyad (192-15-13231)---///\n");
    printf("///-- Md.Humayon Khalid (192-15-13199)-------///\n");
    printf("///-------- Thank You --------///\n\n");
	glutInit(&argc, argv);
	glutInitDisplayMode(GLUT_SINGLE | GLUT_RGB);
	glutInitWindowPosition(50, 50);
	glutInitWindowSize(1900, 1900);
	glutCreateWindow("Smart Mountain Village");
	init();
